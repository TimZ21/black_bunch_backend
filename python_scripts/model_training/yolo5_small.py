...
# It automatically selects GPU if available and handles weight saving/loading during evaluation.
import os
import torch
import subprocess
import sys
...
def train_yolov5():
    command = [
        ...
        '--workers', '1'  # Set number of data loader workers based on system capabilities
    ]
